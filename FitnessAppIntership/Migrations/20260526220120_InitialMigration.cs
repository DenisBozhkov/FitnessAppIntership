        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaximumParticipantsCount = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Equpments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Equpments_Halls_HallId",
                        column: x => x.HallId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subscriptions_AspNetUsers_ResponsibleUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SubscriptionTypesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TrainingsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscriptionTypeEntityTrainingEntity", x => new { x.SubscriptionTypesId, x.TrainingsId });
                    table.ForeignKey(
                        name: "FK_SubscriptionTypeEntityTrainingEntity_SubscriptionTypes_SubscriptionTypesId",
                        column: x => x.SubscriptionTypesId,
                        principalTable: "SubscriptionTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubscriptionTypeEntityTrainingEntity_Trainings_TrainingsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_ResponsibleUserId",
                table: "Subscriptions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionTypeEntityTrainingEntity_TrainingsId",
                table: "SubscriptionTypeEntityTrainingEntity",
                column: "TrainingsId");
